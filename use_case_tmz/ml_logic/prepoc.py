...
def preprocess_features(X: pd.DataFrame):
    ...
    X['New_Site_Categ']=X['New_Site_Categ'].apply(lambda x: clean_category(str(x)))


    geo_final = pd.DataFrame(X['top_geo_code_country'].value_counts().head(20)).index.to_list()
    ...
    X['top_geo_code_country']=X['top_geo_code_country'].apply(lambda x: clean_top_geo(str(x)))
    ...
    X['site_blocklist'] = X['site_blocklist'].fillna(0)
    ...
    y = X['ca_journalier']
    X = X.drop(columns=['Top_Geo','ca_journalier','site_id','site_url','site_category_similar','Category','site_id','site_url','_1', '_2', '_3', '_4', '_5', '_6', '_11','_15', '_16', '_19', '_20', '_24', '_27', '_28', '_30', '_31', '_34','_38', '_39', '_43', '_44', '_46'],axis=1)
...
# ads_format_selected('https://dailyloannews.com', format_44=1, format_11=1)
    ...
    preprocess_features(all_data_for_one_site('https://www.coursfrancaisfacile.com', 1, 'US', format_19=1, format_46=1))
